...
const Ads = () => {
  return (
    <div className=' relative mb-5 mt-[-30px] shadow-md dark:shadow-gray-300 text-center flex items-center flex-col gap-5 border-[1px] border-ModeOne-text dark:border-ModeTwo-text p-5 rounded-lg w-[600px]'>
